...
function empiezaConNueve(n) {
  ...
  //Escribe tu código aquí
let primeroElNueve = n.toString ();
if (primeroElNueve[0] === "9") return true;
return false;
...
function breakStatement(numero) {
  ...
  var sumaDeNumeros = numero;
  var nuevoValor = [];
  for (var i = 0; i < 10; i++) {
    sumaDeNumeros = sumaDeNumeros + 2;

    if (sumaDeNumeros === i) 
      break;
    
     else { nuevoValor.push ( sumaDeNumeros);
    }
  }
...
function continueStatement(numero) {
  ...
  // Tu código:
var sumaDeRecibidos = numero;
var arrayNuevo = [];
for (var i = 0; i < 10; i++) {
  if (i ===5) continue;
    
  sumaDeRecibidos = sumaDeRecibidos + 2;

  arrayNuevo.push(sumaDeRecibidos);
}
return arrayNuevo; 
